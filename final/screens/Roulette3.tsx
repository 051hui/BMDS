...
const restaurants: Array<{ name: string, rating: number, menu: string, dist: string }> = [
    ...
    { name: '쌍대포 소금구이', rating: 4.5, menu: '한방껍데기 특삼겹너덜이', dist: '8분' },
    ...
    { name: '한입소반', rating: 4.4, menu: '묵은지참치김밥 매콤멸치김밥', dist: '7분' },
    { name: '청년다방', rating: 4.4, menu: '차돌떡볶이 버터갈릭감자튀김', dist: '10분' },
    ...
    { name: '신불떡볶이', rating: 4.6, menu: '떡볶이 치즈떡볶이 만두 오뎅', dist: '4분' },
    { name: '경성양꼬치', rating: 4.4, menu: '양꼬치 계란토마토 마파두부', dist: '8분' },
    ...
    { name: '츄르츄르', rating: 4.5, menu: '차슈라멘 연어스시 특초밥', dist: '7분' },
    { name: '스시 사이꼬', rating: 4.3, menu: '사이꼬특초밥 런치점심초밥 연어롤', dist: '8분' },
    { name: '작은도쿄', rating: 4.6, menu: '작은도쿄텐동 바질방울토마토', dist: '8분' },
    ...
    { name: '버거인', rating: 4.6, menu: '지못미버거 트러플감자튀김', dist: '7분' },
    ...
    { name: '요지트', rating: 4.7, menu: '그릭요거트 망고그릭요거트 플레인라씨', dist: '7분' }
]

export default function Roulette3() {
    const [num, change] = useState(20);
